...
.module-group { background: #222; padding: 15px; border-radius: 8px; margin-top: 20px; flex: 1;}
...
.knob-row { display: flex; gap: 15px; flex-direction: column; }
