    ...
    <div class="rack-column">
      ...
      <div class="module-group">
        ...
        <div class="knob-row">
          ...
          <Knob v-else label="D" :min="0" :max="ENV_SYNC_LABELS.length - 1" :step="1" :labels="ENV_SYNC_LABELS" :defaultValue="envDivisionLabelToIndex(DEFAULTS.env1.dDiv)" :modelValue="envDivisionLabelToIndex(params.env1.dDiv)" @update:modelValue="ks.set(['env1', 'dDiv'], ENV_SYNC_LABELS[$event])" :syncPath="ks.pathFor(['env1', 'dDiv'])" @gesture-end="ks.end(['env1', 'dDiv'])" />
          ...
          <Knob v-else label="R" :min="0" :max="ENV_SYNC_LABELS.length - 1" :step="1" :labels="ENV_SYNC_LABELS" :defaultValue="envDivisionLabelToIndex(DEFAULTS.env1.rDiv)" :modelValue="envDivisionLabelToIndex(params.env1.rDiv)" @update:modelValue="ks.set(['env1', 'rDiv'], ENV_SYNC_LABELS[$event])" :syncPath="ks.pathFor(['env1', 'rDiv'])" @gesture-end="ks.end(['env1', 'rDiv'])" />
        </div>
    ...
    <div class="rack-column">
      <div class="module-group">
        ...
        <div class="knob-row">
          ...
          <Knob v-else label="A" :min="0" :max="ENV_SYNC_LABELS.length - 1" :step="1" :labels="ENV_SYNC_LABELS" :defaultValue="envDivisionLabelToIndex(DEFAULTS.env2.aDiv)" :modelValue="envDivisionLabelToIndex(params.env2.aDiv)" @update:modelValue="ks.set(['env2', 'aDiv'], ENV_SYNC_LABELS[$event])" :syncPath="ks.pathFor(['env2', 'aDiv'])" @gesture-end="ks.end(['env2', 'aDiv'])" />
          ...
          <Knob v-else label="D" :min="0" :max="ENV_SYNC_LABELS.length - 1" :step="1" :labels="ENV_SYNC_LABELS" :defaultValue="envDivisionLabelToIndex(DEFAULTS.env2.dDiv)" :modelValue="envDivisionLabelToIndex(params.env2.dDiv)" @update:modelValue="ks.set(['env2', 'dDiv'], ENV_SYNC_LABELS[$event])" :syncPath="ks.pathFor(['env2', 'dDiv'])" @gesture-end="ks.end(['env2', 'dDiv'])" />
          ...
          <Knob v-else label="R" :min="0" :max="ENV_SYNC_LABELS.length - 1" :step="1" :labels="ENV_SYNC_LABELS" :defaultValue="envDivisionLabelToIndex(DEFAULTS.env2.rDiv)" :modelValue="envDivisionLabelToIndex(params.env2.rDiv)" @update:modelValue="ks.set(['env2', 'rDiv'], ENV_SYNC_LABELS[$event])" :syncPath="ks.pathFor(['env2', 'rDiv'])" @gesture-end="ks.end(['env2', 'rDiv'])" />
        </div>
    ...
    <div class="rack-column">
      <div class="module-group">
        ...
        <div class="knob-row">
          ...
          <Knob v-else label="A" :min="0" :max="ENV_SYNC_LABELS.length - 1" :step="1" :labels="ENV_SYNC_LABELS" :defaultValue="envDivisionLabelToIndex(DEFAULTS.env3.aDiv)" :modelValue="envDivisionLabelToIndex(params.env3.aDiv)" @update:modelValue="ks.set(['env3', 'aDiv'], ENV_SYNC_LABELS[$event])" :syncPath="ks.pathFor(['env3', 'aDiv'])" @gesture-end="ks.end(['env3', 'aDiv'])" />
          ...
          <Knob v-else label="D" :min="0" :max="ENV_SYNC_LABELS.length - 1" :step="1" :labels="ENV_SYNC_LABELS" :defaultValue="envDivisionLabelToIndex(DEFAULTS.env3.dDiv)" :modelValue="envDivisionLabelToIndex(params.env3.dDiv)" @update:modelValue="ks.set(['env3', 'dDiv'], ENV_SYNC_LABELS[$event])" :syncPath="ks.pathFor(['env3', 'dDiv'])" @gesture-end="ks.end(['env3', 'dDiv'])" />
          ...
          <Knob v-else label="R" :min="0" :max="ENV_SYNC_LABELS.length - 1" :step="1" :labels="ENV_SYNC_LABELS" :defaultValue="envDivisionLabelToIndex(DEFAULTS.env3.rDiv)" :modelValue="envDivisionLabelToIndex(params.env3.rDiv)" @update:modelValue="ks.set(['env3', 'rDiv'], ENV_SYNC_LABELS[$event])" :syncPath="ks.pathFor(['env3', 'rDiv'])" @gesture-end="ks.end(['env3', 'rDiv'])" />
        </div>
