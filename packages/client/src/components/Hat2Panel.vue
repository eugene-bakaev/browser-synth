...
const ks = useKnobSync('hat2');

defineProps<{
  params: EngineParamsMap['hat2'];
...
<style scoped>
/* hat2 has 6 knobs — more than the 3-knob analog drum panels (like kick2's 8) — so
   wrap them into rows instead of overflowing the rack column (the default
