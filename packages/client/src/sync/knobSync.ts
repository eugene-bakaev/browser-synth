...
// App.vue's synth context (created exactly once by the shell). App provides it
// via inject; panels pull it through this composable, along with the context's
// dispatchLocal/endGesture write primitives.
//
